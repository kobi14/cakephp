...
class UsersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'confirmpassword' => ['type' => 'string', 'length' => 100, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created' => '2019-03-27 10:25:56',
                'modified' => '2019-03-27 10:25:56'
            ],
        ];
        parent::init();
    }
